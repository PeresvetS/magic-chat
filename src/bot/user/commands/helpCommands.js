...
/mailing_test [номер] [telegram|whatsapp|tgwa] - Отправить тестовое сообщение активной кампании на указан��ый номер. Например: /mailing_test +79123456789 telegram
...
/create_kb [название] [ID_кампании] - Создать новую базу знаний. Например: /create_kb МояБазаЗнаний 123

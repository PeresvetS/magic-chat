...
const config = {
  ...
  BITRIX24_OUTBOUND_WEBHOOK_TOKEN: process.env.BITRIX24_OUTBOUND_WEBHOOK_TOKEN,
  BITRIX24_INBOUND_WEBHOOK_URL: process.env.BITRIX24_INBOUND_WEBHOOK_URL,
  MAIN_PHONE_NUMBER: process.env.MAIN_PHONE_NUMBER,
